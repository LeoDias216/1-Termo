...
print(manipulacao_arquivos.strip()) # Remove espaços em branco como "Clean      Code    "
...
print(manipulacao_arquivos.upper().count("PYTHON")) # Conta quantas vezes a palavra "PYTHON" aparece na string e converte para maiúsculas
print(manipulacao_arquivos.strip().count("Python")) # Conta quantas vezes a palavra "Python" aparece na string, removendo os espaços em branco
...
# Exercício 1: Crie um algoritmo onde peça para inserir uma frase e deixa-a formatada com maiúscula e acrescente uma contagem de cada frase

# frase_usuario = input("Insira sua frase aqui: ")
...
# Exercício 2: Crie um algoritmo para criação de um arquivo que irá desligar o computador.
# with open ("desligar.bat" , "w") as desligar:
#     desligar.write('Shutdown /s /t 300 /c "Sextou! Pode descansar"')

# Exercício 3: Crie um algoritmo para cancelar o desligamento do computador

# with open ("anular.bat" , "w") as anular:
#     anular.write('Shutdown /a')

# Exercicio 4: Crie um algoritmo para listar os arquivos do diretório atual e do diretório pai.

# import os
# print("Arquivos do diretório atual:")
# print(os.listdir())

# Exercício 5: Crie um algoritmo para criar um diretório, renomeá-lo e depois excluí-lo.

# import os
# os.mkdir("Carlos")
# os.rename("Carlos", "Magnum")
# os.rmdir("Magnum")
